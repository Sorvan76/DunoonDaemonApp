...
DUAL_CHANNEL_SYSTEM_DIRECTIVE = (
    ...
    "Judge progress by actual state transition, not by effort, intention, urgency, or descriptive motion alone. "
    "Repeatedly attempting the same unresolved action from effectively the same state should score low. "
    "Reaching a destination, changing separation, completing an action, causing/receiving a consequence, or materially altering constraints should score higher.\n"
